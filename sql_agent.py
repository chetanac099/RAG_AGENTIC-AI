...
mysql_username = 'root'
mysql_password = 'KA6mHrcip5TvPWFLKN3EorfR' # Replace with your server connect information
mysql_host = '172.21.254.102' # Replace with your server connect information
...
agent_executor = create_sql_agent(llm=llm, db=db, verbose=True, handle_parsing_errors=True, agent_type= "zero-shot-react-description") #AgentType.ZERO_SHOT_REACT_DESCRIPTION)
